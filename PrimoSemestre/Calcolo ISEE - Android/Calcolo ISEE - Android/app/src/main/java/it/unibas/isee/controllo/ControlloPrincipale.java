...
public class ControlloPrincipale {
    ...
    private class AzioneCalcola implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            //!!!!!!!!!!!!!! In un'applicazione persistente non ci sarebbe stato bisogno di farlo,
            // ma se vogliamo che l'oggetto sia persistente dobbiamo necessariamente invocare il metodo saveBean di ModelloPersistente,
            // poiché anche se il riferimento all'oggetto non è cambiato, dobbiamo aggiornare la versione che abbiamo salvato su disco
            // (perché ovviamente il file su disco non è che si mantiene aggiornato automaticamente)
